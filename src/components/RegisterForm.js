...
class Register extends Component {
    ...
    render() {
        ...
        const { first_name, last_name, email, address, password, confirm_password } = this.state.user;
                    ...
                    <div className="form-horizontal">
                            ...
                            <div className="cols-sm-10">
                                <div className="input-group">
                                    ...
                                    <input
                                        ...
                                        value={first_name}
                                        onChange={(e) => {updateUserState("first_name", e)}}
                            ...
                            <div className="cols-sm-10">
                                <div className="input-group">
                                    ...
                                    <input type="text"
                                           className="form-control"
                                           value={last_name}
                                           onChange={(e) => {updateUserState("last_name", e)}}
                            ...
                            <div className="cols-sm-10">
                                <div className="input-group">
                                    ...
                                    <input type="text"
                                           className="form-control"
                                           value={address}
                                           onChange={(e) => {updateUserState("address", e)}}
                        ...
                        <div className="form-group">
                            ...
                            <div className="cols-sm-10">
                                <div className="input-group">
									<span className="input-group-addon">
                                        <i className="fa fa-lock fa-lg" aria-hidden="true"/></span>
                                    <input type="password"
                                           className="form-control"
                                           value={confirm_password}
                                           onChange={(e) => {updateUserState("confirm_password", e)}}
